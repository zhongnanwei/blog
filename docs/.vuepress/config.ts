...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
    ...
    themeConfig: {
            ...
            { text: "首页", link: "/" },
            {
                ...
                items: [
                    ...
                    },
                    {
                        text: "网络",
                        items: [
                            { text: "网络初探", link: "/pages/7c4849/" },
                            { text: "http状态码", link: "pages/350dcf" },
                        ],
                    },
                ],
            },
        ...
        repo: "zhongnanwei/blog", // 导航栏右侧生成Github链接
        ...
        author: {
            name: "Arthas", // 必需
            link: "https://github.com/zhongnanwei", // 可选的
        },
        ...
        footer: {
            ...
            copyrightInfo: 'Arthas | <a href="#" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
        },
        ...
        [
            "vuepress-plugin-comment", // 评论
            {
                ...
                options: {
                    ...
                    repo: "blog", // GitHub 仓库
                    owner: "zhongnanwei", // GitHub仓库所有者
                    admin: ["zhongnanwei"], // 对仓库有写权限的人
